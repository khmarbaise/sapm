 ...
 *
 */
public class AccessRulesConfigReducePermissionDifferentOrderTest extends TestBase {
    ...
    public void beforeMethod() throws org.antlr.runtime.RecognitionException, FileNotFoundException, IOException {
        FileInputStream fis = new FileInputStream(
                getFileResource("/svnaccess-reducing-permission-different-order.conf"));
    ...
    public Object[][] createAccessSet() {
        return new Object[][] {
            ...
            { "jenny",      "calc", "/project/",       AccessLevel.READ_WRITE },
            { "joe",        "calc", "/project/",       AccessLevel.READ_WRITE },
            { "danny",      "calc", "/project/",       AccessLevel.READ_WRITE },

            { "sally",      "calc", "/project/",       AccessLevel.NOTHING },
            { "decon",      "calc", "/project/",       AccessLevel.NOTHING },
