...
/**
 * This test will create access rules which are read from configuration file
 * (svnaccess-aliases.conf) and the same as already defined in the
 * {@link AccessRulesGroupGroupTest} file. This will make sure that the object
 * tree which has been read via the parser is the same as it would be if it had
 * been created manually as in {@link AccessRulesGroupGroupTest}.
 *
 ...
 *
 */
public class AccessRulesGroupGroupFromConfigFileWithAliasesTest extends TestBase {
    ...
    public Object[][] createAccessSet() {
        return new Object[][] {
            ...
            { "joe",        "repository", "/",                          AccessLevel.READ },
            ...
            { "joe",        "repository", "/project-c/",                AccessLevel.READ },
            { "joe",        "repository", "/project-d/",                AccessLevel.READ },
            { "joe",        "repository", "/project-e/",                AccessLevel.READ },
            ...
            { "joe",        "repository", "/project-c/trunk/",          AccessLevel.READ },
            ...
            { "joe",        "repository", "/project-d/trunk/",          AccessLevel.READ },
            ...
            { "joe",        "repository", "/project-e/trunk/",          AccessLevel.READ_WRITE },
            ...
            { "joe",        "global",     "/project/trunk/",            AccessLevel.READ_WRITE },
            ...
            { "joe",        "global",     "/project/",                  AccessLevel.READ },
